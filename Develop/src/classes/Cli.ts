  ...
  findVehicleToTow(vehicle: Truck): void {
    inquirer
      ...
      .then((answers: { vehicleToTow: Car | Truck | Motorbike }) => {
        ...
        const selectedVehicle = answers.vehicleToTow as Car | Truck | Motorbike;
        ...
        if (selectedVehicle.vin === vehicle.vin) {
          ...
          console.log(
            `Towing ${selectedVehicle.make} ${selectedVehicle.model} with ${vehicle.make} ${vehicle.model}...`
          );
          this.performActions();
        }
      });
      ...
      .then((answers: { action: string }) => {
        ...
        // TODO: add statements to perform the wheelie action only if the selected vehicle is a motorbike
          ...
          if (selectedVehicle instanceof Truck) {
            ...
            console.log('Error: Only a truck can tow another vehicle!');
          }
        }
          ...
          if (selectedVehicle instanceof Motorbike) {
            ...
            console.log('Error: Only a motorbike can do a wheelie!');
          }
        }
